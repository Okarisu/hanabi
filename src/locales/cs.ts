export const cs = {
  ...
  welcome: "Vítej",
  newGame: "Nová hra",
  tagline: "Zahraj si Hanabi s přáteli online!",
  subTagline: "Kooperativní karetní hra pro více hráčů dostupná na telefonu, tabletu a počítači",
  createRoom: "Vytvořit místnost",
  joinRoom: "Přidat se do místnosti",
  rejoinGame: "Znovu se připojit",
  whatsHanabi: "Co je Hanabi?",
  invitationByPlayers: "{{playerNames}} Tě zve si zahrát Hanabi 🎉",
  invitationByPlayers_plural: "{{playersNames}} Tě zvou si zahrát Hanabi 🎉",
  invitationNoPlayers: "Byl(a) jsi pozvána zahrát Hanabi 🎉",
  gameFull: "Všichni jsou tu!",
  gameNotFull_0: "{{count}} z {{playersCount}} hráčů se připojil",
  gameNotFull_1: "{{count}} z {{playersCount}} hráčů se připojili",
  gameNotFull_2: "{{count}} z {{playersCount}} hráčů se připojilo",
  startGame: "Začít hru",
  addAi: "+ přidat bota",
  lobby: "Lobby",
  choosePlayerName: "Vyber si jméno",
  join: "Přidat se",
  autoplay: "Automatická hra",
  shareGame: "Sdílej tuto hru",
  copy: "Kopírovat",
  waitForOthers: "Počkej na ostatní, nebo ",
  gameStarted: "Hra začala!",
  gameStarts: "Hra začíná!",
  discardPile: "Odhazovací balíček ({{ discardLength }})",
  preventLossContent: "Udělal jsi chybu. Pokračovat?",
  rewind: "🕑 Přehrát historii",
  backToGame: "Zpátky do hry",
  theirTurn: "{{currentPlayerName}} je na tahu!",
  go: "Do toho",
  estimatedMaxScore: "Odhadované skóre pro tento balíček: {{reachableScore}}.",
  keepPracticing: "Ještě cvičte",
  congrats: "Neuvěřitelné!",
  hideStats: "Schovat statistiky",
  showStats: "Ukázat statistiky",
  gameOver: "Konce hry! • Vaše skóre je {{playedCardsLength}} 🎉",
  score: "Hanabi • Skóre: {{score}} / {{maxPossibleScore}}",
  turnsLeftDisclaimer_0: "· Poslední tah",
  turnsLeftDisclaimer_1: "· {{count}} tahy do konce",
  turnsLeftDisclaimer_2: "· {{count}} tahů do konce",
  cardLeft: "Zbývá {{pileLength}} karet v balíčku",
  tokens: "žetony",
  deck: "balíček",
  loading: "Načítání...",
  menu: "Menu",
  ...
  youWillStart: "Začínáš",
  hide: "Skrýt",
  reveal: "Zobrazit",
  cardSelected: "Vybrána karta {{position}}",
  eightTokens: "8 nápověd",
  cannotDiscard: "Nemůžeš zahodit kartu",
  noTokens: "Nezbývají žádné nápovědy",
  selectVignette: "Vyber buď barvu, nebo číslo, které napovíš",
  hint: "Nápověda",
  negativeHintColor: "Nemáš žádné {{ color }} karty",
  negativeHintNumber: "Nemáš žádné {{ number }}",
  positiveHintColor: " {{ positions }} is {{ color }}",
  ...
  learn: {
    ...
    tokens: {
      title: "Žetony",
      1: "Žetony nápovědy ti dovolují poradit jinému hráči.",
      2: "Na začátku hry máte 8 žetonů nápovědy.",
      3: "Žeton výbuchu dostanete, když někdo z hráčů zahraje nehratelnou kartu.",
      4: "Po 3 výbuších jste hru prohráli.",
    },
    ready: {
      title: "Připraveni?",
      1: "Pojďme si to vyzkoušet na cvičné hře!",
      2: "Hanabi je hra s nekonečným množstvím možností  game with endless options and possibilities. There is no right choice when playing.",
